...
function edudetails(e){
	...
	tb.border="2";
	var tr1="<tr><td>degree</td><td>institute</td><td>yearofpassing</td></tr>";
	var tr2="";
	for(i=0;i<e.length;i++){
		tr2=tr2+"<tr><td>"+e[i].degree+"</td><td>"+e[i].institute+"</td><td>"+e[i].yearofpassing+"</td></tr>";
	}
